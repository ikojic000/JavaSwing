...
public class TextAreaScroll extends JScrollPane {
	...
	public TextAreaScroll() {
		...
		setVerticalScrollBar( new ScrollBarCustom( 40 ) );
		ScrollBarCustom scrol = new ScrollBarCustom( 40 );
		scrol.setOrientation( JScrollBar.HORIZONTAL );
		scrol.setForeground( new Color( 46 , 191 , 165 ) );
