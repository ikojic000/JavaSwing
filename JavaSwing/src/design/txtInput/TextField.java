...
//    private int spaceHelperText = 5;
	private int spaceHelperText = 15;
//    private int spaceHelperText = 23;
	private Color lineColor = new Color( 46 , 191 , 165 );
	private Color hintTextColor = new Color( 121 , 118 , 118 );
	
	public TextField() {
		
		setBorder( new EmptyBorder( 10 , 3 , 3 , 3 ) );
		setSelectionColor( new Color( 189 , 239 , 230 ) );
		setCaretColor( new Color( 46 , 191 , 65 ) );
...
//            setHintTextColor(new Color(44, 51, 51));
		} else {
			
//        	setHintTextColor(new Color(121, 118, 118));
	...
	private void createHintText( Graphics2D g2 ) {
		...
		if ( animateHinText ) {
			...
			if ( show ) {
				...
				size = 18 * (1 - location);
				g2.setColor( new Color( 121 , 118 , 118 ) );
				
			} else {
				
				if ( location > 0.0f ) {
					
					g2.setColor( new Color( 44 , 51 , 51 ) );
...
//			setHintTextColor(Color.red);
	...
	private void createHelperText( Graphics2D g2 ) {
		...
		if ( helperText != null && !helperText.equals( "" ) ) {
			...
			Font font = getFont();
			g2.setFont( font.deriveFont( 0 , font.getSize() - 3 ) );
			FontMetrics ft = g2.getFontMetrics();
			Rectangle2D r2 = ft.getStringBounds( labelText , g2 );
