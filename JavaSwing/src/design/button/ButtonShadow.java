...
public class ButtonShadow extends JButton {
	...
	public void setForegroundColorIN( Color foregroundColorIN ) {
		
		this.foregroundColorIN = foregroundColorIN;
		
	}
	
	
	public void setForegroundColorOUT( Color foregroundColorOUT ) {
		
		this.foregroundColorOUT = foregroundColorOUT;
	...
	private Color foregroundColorIN = new Color( 44 , 51 , 51 );
	private Color foregroundColorOUT = new Color( 121 , 118 , 118 );
	...
	public ButtonShadow() {
		...
		addMouseListener( new MouseAdapter() {
			...
			public void mouseEntered( MouseEvent e ) {
				...
				setForeground( foregroundColorIN );
			...
			public void mouseExited( MouseEvent e ) {
				...
				setForeground( foregroundColorOUT );
