...
public class ButtonCustom extends JButton {
	...
	public enum ButtonStyle {
							 ...
							 PRIMARY(new Color( 44 , 51 , 51 ), new Color( 121 , 118 , 188 ), new Color( 66 , 76 , 76 ),
									 new Color( 57 , 65 , 65 )) ,
							 SECONDARY(new Color( 203 , 209 , 219 ), new Color( 58 , 70 , 81 ),
									 new Color( 81 , 92 , 108 ), new Color( 230 , 239 , 255 )) ,
							 DESTRUCTIVE(new Color( 146 , 20 , 12 ), new Color( 244 , 244 , 249 ),
									 new Color( 189 , 27 , 15 ), new Color( 170 , 24 , 14 ));
