...
public class ComboSuggestionUI extends BasicComboBoxUI {
	...
	public void installUI( JComponent jc ) {
		...
		txt.addFocusListener( new FocusAdapter() {
			...
			public void focusGained( FocusEvent fe ) {
				...
				border.setColor( new Color( 46 , 191 , 165 ) );
			...
			public void focusLost( FocusEvent fe ) {
				...
				border.setColor( new Color( 121 , 118 , 118 ) );
		...
		txt.setSelectionColor( new Color( 189 , 239 , 230 ) );
	...
	protected ListCellRenderer createRenderer() {
		...
		return new ListCellRenderer() {
			...
			@Override
			public Component getListCellRendererComponent( JList jlist , Object e , int i , boolean bln ,
														   boolean bln1 ) {
				...
				if ( bln ) {
					...
					label.setForeground( new Color( 46 , 191 , 165 ) );
	...
	private class ComboSuggestionPopup extends BasicComboPopup {
		...
		protected JScrollPane createScroller() {
			...
			ScrollBarCustom sb = new ScrollBarCustom( 40 );
			sb.setPreferredSize( new Dimension( 8 , 70 ) );
			scroll.setVerticalScrollBar( sb );
			ScrollBarCustom sbH = new ScrollBarCustom( 40 );
	...
	private class Border extends EmptyBorder {
		...
		private Color focusColor = new Color( 46 , 191 , 165 );
		private Color color = new Color( 121 , 118 , 118 );
